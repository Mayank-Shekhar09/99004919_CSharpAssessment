    ...
    class Program
    {
        static void Main(string[] args)
        {
            try
            {
                ...
                Console.WriteLine("The total cost for {0} packets of {1} is {2}/- INR", quantityToBuy, gosObj.ItemName, gosObj.PayPerPiece(quantityToBuy, gosObj.ItemName));
                Console.WriteLine("The total cost for {0} grams of {1} is {2}/- INR", quantityInGrams, gosTwoObj.ItemName, gosTwoObj.PayPerPiece(quantityToBuy, gosTwoObj.ItemName));
                ...
                Console.WriteLine("The total cost for {0} packets of {1} is {2}/- INR", quantityToBuyCoffee, coffObj.ItemName, coffObj.PayPerPiece(quantityToBuy, coffObj.ItemName));
                Console.WriteLine("The total cost for {0} grams of {1} is {2}/- INR", quantityInGramsCoffee, coffTwoObj.ItemName, coffTwoObj.PayPerPiece(quantityToBuy, coffTwoObj.ItemName));
            }
            catch(Exception e)
            {
